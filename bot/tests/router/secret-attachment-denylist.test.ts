...
// sendable to a (public) chat, while ordinary files are allowed (owner
...
describe('isSecretAttachmentPath', () => {
  test('BLOCKS secret material (path-based)', () => {
    for (const p of [
      '/home/openclaw/.claude-lab/agent-c/secrets/socialdata.env',
      ...
      '/home/openclaw/.secrets/firebase/sa-agent-c.json',
  ...
  test('ALLOWS ordinary files (any path, any common type)', () => {
    for (const p of [
      '/home/openclaw/.claude-lab/agent-c/.claude/skills/present/present-gbrain.html',
      '/tmp/report.pdf',
      '/home/x/cover.png',
      '/home/x/cowork-1.txt',
      '/home/x/diagram.svg',
