...
//     → UI sends Allow/Deny keyboard → owner taps → callback → relay.answer()
...
// owner tap. Timeout, expire, and any non-allow transition resolve to deny
...
export interface PermissionGateRelay {
  ...
  /** Resolve a pending request with the owner's tap. First tap wins;
